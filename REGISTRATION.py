...
def second():
    global secondw
    secondw=Tk()
    secondw.title("Panipat Institute of Engneering")
    ...
    def distroy5():
        secondw.destroy()
        window()
    mainlabel= Label(secondw,text="Panipat Institute of Engneering", font=("times new roman", 35), bg="MediumOrchid2")
    mainlabel.pack(side=TOP, fill=X)
...
def root():
    ...
    root.title("Panipat Institute of Engneering")
    global entry1
    global entry2
    global entry3
    global entry4
